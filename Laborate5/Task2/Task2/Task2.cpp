...
public:
    ...
    void showData() override {
        ...
        if (isOversize(*this))
            cout << "Count of pages: Out of range!" << endl << endl;
        else
            cout << "Count of pages: " << countofPages << endl << endl;
    }

    bool isOversize(Book &obj) {
        return obj.countofPages > 800;
    }
};
...
public:
    ...
    void showData() override {
        ...
        cout << "Price: " << price << " uan." << endl;
        if (isOversize(*this))
            cout << "Recording time: Out of range!" << endl << endl;
        else
            cout << "Recording time: " << time << " min." << endl << endl;
        
    }

    bool isOversize(Type& obj) {
        return obj.time > 90;
    }
};
...
int main()
{
    ...
    cout << "Laborate Work 5. Task 2." << endl << endl;
    Publication* arr[4];
    int j = 0;
    while (j < 4) {
        int answer;
